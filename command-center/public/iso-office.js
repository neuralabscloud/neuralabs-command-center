...
(function () {
  ...
  const OFFICE = [
    ...
    { key:'community',    name:'SOCIAL MEDIA', role:'X / TELEGRAM', emoji:'\u{1F4AC}', hsl:'200 90% 55%', pos:[2,1], href:'community-manager.html', taskApi:'/community/tasks', isCommunity:true },
  ];
